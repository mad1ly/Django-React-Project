...
def executeAPIrequest(session_key, endpoint, post_=False, put_=False):
    tokens = get_user_tokens(session_key)
...
def play_song(session_key):
    return executeAPIrequest(session_key, "player/play", put_=True)


def pause_song(session_key):
    return executeAPIrequest(session_key, "player/pause", put_=True)


def skip_song(session_key):
    return executeAPIrequest(session_key, "player/next", post_=True)
